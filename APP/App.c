...
void App_UART_Recieve_task( void * pvParameters )
{
...
{
    xTaskCreate(App_init, "Init", configMINIMAL_STACK_SIZE, NULL, 10, NULL);
    xTaskCreate(App_sendToUart, "UART_S", configMINIMAL_STACK_SIZE, NULL, 2, &GH_UART);
    xTaskCreate(App_updateLED0, "LED_0", configMINIMAL_STACK_SIZE, NULL, 4, &GH_LED_0);
    xTaskCreate(App_updateLED1, "LED_1", configMINIMAL_STACK_SIZE, NULL, 4, &GH_LED_1);
    xTaskCreate(App_UART_Recieve_task, "UART_R", configMINIMAL_STACK_SIZE, NULL, 5, &GH_UART_R);
    xTaskCreate(App_getButton, "BTN", configMINIMAL_STACK_SIZE, NULL, 7, NULL);
    xTaskCreate(App_getKeypad, "keypad", configMINIMAL_STACK_SIZE, NULL, 1, &GH_KEYPAD);
    vTaskStartScheduler();
}
